...
export const Projects = () => {
    ...
    const projects = [
      {
        title: "Movies-app",
        link: "https://moviem-app.netlify.app",
        imgUrl: projImg1,
      },
      {
        title: "Portfolio-website",
        link: "https://abdelrhman-ragab-portfolio.netlify.app",
        imgUrl: projImg2,
      },
      {
    ...
    return (
      ...
      <img className="background-image-right" src={colorSharp2} alt="Image55"></img>
    </section>
    )
}